...
#define CURVE_TYPE_CARDINAL 5
#define CURVE_TYPE_DCJAU 6
#define CURVE_TYPE_QUAD 7
#define CURVE_TYPE_LREISEN 8
#define CURVE_TYPE_C0BEZ 9
#define CURVE_TYPE_C1BEZ 10
#define CURVE_TYPE_CINVBEZ 11
#define CURVE_TYPE_COUNT 12
